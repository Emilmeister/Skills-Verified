"""Gemini CLI workspace skill discovery."""
...
class GeminiProfile(PlatformProfile):
    name = "gemini"
    ...
    def get_detection_evidence(self, repo_path: Path) -> list[Path]:
        ...
        return [
            ...
            for path in manifests_under(root, (".gemini", "skills"))
        ]
    ...
    def get_skill_metadata_all(self, repo_path: Path) -> list[SkillMetadata]:
        ...
        return [
            ...
            for manifest in manifests_under(root, (".gemini", "skills"))
        ]
